...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'evalia@app.com')

# Email backend - fallback to file if no SMTP configured
if not EMAIL_HOST or not EMAIL_HOST_PASSWORD:
    EMAIL_BACKEND = 'django.core.mail.backends.filebased.EmailBackend'
    import os as _os
    _email_dir = BASE_DIR / 'media' / 'emails'
    _os.makedirs(_email_dir, exist_ok=True)
